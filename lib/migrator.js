...
internals.executeMigration = async (migration, rollback) => {
    ...
    for (const migrationDir of migrationDirs) {
        directoriesToRead.push(internals.readMigrationDir(migrationDir, symlinkStore));
    }
...
internals.readMigrationDir = async (migrationDir, symlinkStore) => {
    ...
    const symlinkConfig = Object.assign({ migrationDir }, symlinkStore);
