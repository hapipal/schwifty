...
exports.register = (server, options, next) => {
    ...
    if (typeof options.migrate !== 'undefined') {
        Hoek.assert(rootCollector.migrate === null, 'Schwifty\'s migrate option can only be specified once.');
        rootCollector.migrate = options.migrate;
    }
