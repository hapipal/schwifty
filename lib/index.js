...
exports.register = function (server, options, next) {
    ...
    /*
        Move the models into the knexFile object
        Since a models path isn't part of it's schema on knexjs.org
    */

    if (options.models) {
        knexFile.models = options.models;
    }
...
exports.Model = class SchwiftyModel extends Model {
    ...
    $validate(json = this, options = {}) {
        ...
        if (validation.error) {
            ...
            throw new Objection.ValidationError(this.parseValidationError(validation.error.details));
        }
...
internals.schwifty = function (config) {
    ...
    else if (typeof config === 'function' && config.tableName) {
