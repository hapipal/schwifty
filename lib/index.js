...
exports.register = (server, options, next) => {
    ...
    if (typeof options.migrationsMode !== 'undefined') {
        Hoek.assert(rootCollector.migrationsMode === undefined, 'Schwifty\'s migrationsMode option can only be specified once.');
        rootCollector.migrationsMode = options.migrationsMode;
    }
        ...
        if (typeof collector.migrationsMode !== 'undefined') {
            ...
            (err) => {
                ...
                if (err) {
                    ...
                    return internals.stop(server, (stopErr) => {
