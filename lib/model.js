...
module.exports = class SchwiftyModel extends Objection.Model {
    ...
    // this._jsonAttributesMemo === this.jsonAttributes
    static get jsonAttributes() {
        ...
        // Setting this._jsonAttributesMemo here. See the 'jsonAttributes' setter.
        this._jsonAttributesMemo = Object.keys(schemaKeyDescs).filter((field) => {
